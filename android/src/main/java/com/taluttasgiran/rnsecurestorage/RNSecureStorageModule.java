...
import com.taluttasgiran.rnsecurestorage.cipherStorage.CipherStorage.DecryptionContext;
...
import com.taluttasgiran.rnsecurestorage.cipherStorage.CipherStorageBase;
...
public class RNSecureStorageModule extends ReactContextBaseJavaModule {
    ...
    private static final String LOG_TAG = RNSecureStorageModule.class.getSimpleName();
     ...
     */
    public static RNSecureStorageModule withWarming(@NonNull final ReactApplicationContext reactContext) {
        final RNSecureStorageModule instance = new RNSecureStorageModule(reactContext);
    ...
    private void internalWarmingBestCipher() {
        try {
            ...
            Log.v(RN_SECURE_STORAGE, "warming up started at " + startTime);
            ...
            Log.v(RN_SECURE_STORAGE, "warming up takes: " +
                    TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - startTime) +
                    " ms");
        } catch (Throwable ex) {
            Log.e(RN_SECURE_STORAGE, "warming up failed!", ex);
        }
    }
    //endregion
    ...
    protected void setGenericPassword(@NonNull final String alias,
                                      ...
                                      @androidx.annotation.Nullable final ReadableMap options,
    ...
    @ReactMethod
    public void setGenericPasswordForOptions(@androidx.annotation.Nullable final ReadableMap options,
                                             @NonNull final String username,
                                             @NonNull final String password,
                                             @NonNull final Promise promise) {
     ...
     */
    @NonNull
    private CipherStorage getSelectedStorage(@androidx.annotation.Nullable final ReadableMap options)
    ...
    protected void getGenericPassword(@NonNull final String alias,
        ...
        try {
            ...
            if (resultSet == null) {
                Log.e(RN_SECURE_STORAGE, "No entry found for service: " + alias);
            ...
            Log.e(RN_SECURE_STORAGE, e.getMessage());
    ...
    @ReactMethod
    public void getGenericPasswordForOptions(@androidx.annotation.Nullable final ReadableMap options,
                                             @NonNull final Promise promise) {
        final String service = getServiceOrDefault(options);
    ...
    @ReactMethod
    public void resetGenericPasswordForOptions(@androidx.annotation.Nullable final ReadableMap options,
                                               @NonNull final Promise promise) {
        final String service = getServiceOrDefault(options);
    ...
    @ReactMethod
    public void getSecurityLevel(@androidx.annotation.Nullable final ReadableMap options,
                                 @NonNull final Promise promise) {
     ...
     */
    @NonNull
    private static String getServiceOrDefault(@androidx.annotation.Nullable final ReadableMap options) {
        String service = null;
    ...
    @Rules
    @NonNull
    private static String getSecurityRulesOrDefault(@androidx.annotation.Nullable final ReadableMap options) {
    ...
    private static String getSpecificStorageOrDefault(@androidx.annotation.Nullable final ReadableMap options) {
    ...
    @AccessControl
    @NonNull
    private static String getAccessControlOrDefault(@androidx.annotation.Nullable final ReadableMap options) {
     ...
     */
    @NonNull
    private static SecurityLevel getSecurityLevelOrDefault(@androidx.annotation.Nullable final ReadableMap options) {
     ...
     */
    public static boolean getUseBiometry(@AccessControl @androidx.annotation.Nullable final String accessControl) {
     ...
     */
    @NonNull
    private static BiometricPrompt.PromptInfo getPromptInfo(@androidx.annotation.Nullable final ReadableMap options) {
    ...
    private DecryptionResult decryptCredentials(@NonNull final String alias,
        ...
        if (Rules.AUTOMATIC_UPGRADE.equals(rules)) {
            try {
                ...
                Log.w(RN_SECURE_STORAGE, "Migrating to a less safe storage is not allowed. Keeping the old one");
            }
        }
     ...
     */
    @NonNull
    protected DecryptionResultHandler getInteractiveHandler(@NonNull final CipherStorage current, @NonNull final BiometricPrompt.PromptInfo promptInfo) {
     ...
     */
    public static void throwIfEmptyLoginPassword(@androidx.annotation.Nullable final String username,
                                                 @androidx.annotation.Nullable final String password)
    ...
    private SecurityLevel getSecurityLevel(final boolean useBiometry) {
        try {
            ...
            Log.w(RN_SECURE_STORAGE, "Security Level Exception: " + e.getMessage(), e);
    ...
    @NonNull
    private static String getAliasOrDefault(@androidx.annotation.Nullable final String service) {
    ...
    private class InteractiveBiometric extends BiometricPrompt.AuthenticationCallback implements DecryptionResultHandler {
        ...
        private InteractiveBiometric(@NonNull final CipherStorage storage, @NonNull final BiometricPrompt.PromptInfo promptInfo) {
        ...
        @Override
        public void onDecrypt(@androidx.annotation.Nullable final DecryptionResult decryptionResult, @androidx.annotation.Nullable final Throwable error) {
        ...
        public void waitResult() {
            ...
            Log.i(RN_SECURE_STORAGE, "blocking thread. waiting for done UI operation.");
            ...
            Log.i(RN_SECURE_STORAGE, "unblocking thread.");
        }
    }
    //endregion
