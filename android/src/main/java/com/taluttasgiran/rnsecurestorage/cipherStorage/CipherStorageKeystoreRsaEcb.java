...
import com.taluttasgiran.rnsecurestorage.RNSecureStorageModule;
...
public class CipherStorageKeystoreRsaEcb extends CipherStorageBase {
    ...
    public EncryptionResult encrypt(@NonNull final String alias,
        ...
        try {
            return innerEncryptedCredentials(safeAlias, value, level);
    ...
    public DecryptionResult decrypt(@NonNull String alias,
        ...
        decrypt(handler, alias, value, level);
    ...
    public void decrypt(@NonNull DecryptionResultHandler handler,
        ...
        try {
            ...
            @SuppressWarnings("ConstantConditions") final DecryptionContext context =
                    new DecryptionContext(safeAlias, key, value);
    ...
    public String getCipherStorageName() {
        return RNSecureStorageModule.KnownCiphers.RSA;
    }
    ...
    /**
     * Clean code without try/catch's that encrypt username and value with a key specified by alias.
     */
    @NonNull
